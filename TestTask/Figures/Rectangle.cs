...
namespace Figures
{
    ...
    {
        /// <summary>
        /// Designed to create an instance of the Rectangle class
        /// </summary>
        /// <param name="points"></param>
        /// <param name="figureType"></param>
        
        public Rectangle(int[] points,string figureType) : base(points,figureType)
        {
        }
        ...
        public static bool IsThisFigure(int[] points)
        {
            ...
            if (points.Length == 8)
            {
                ...
                if (sides[0] != 0 && sides[0] == sides[1] && sides[2] == sides[3] && sides[4] == sides[5])
                {
                    isFigure = true;
                }
            }
